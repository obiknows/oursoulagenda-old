    ...
    <div style={{color: 'white', textAlign: 'center', marginTop: 40,}}>
      <h1>Terms and Conditions</h1>
        ...
        <ul>
              ...
              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Our Soul Agenda.</li>
          ...
          <li><strong>Website</strong> refers to Our Soul Agenda, accessible from oursoulagenda.com</li>    <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
        </ul>
        ...
        <ul>
                  <li>By visiting this page on our website: oursoulagenda.com/contact</li>
              </ul>
    </div>
